        ...
        <div class="row">
            ...
            <div class="card card-details">
                    ...
                    @forelse ($item->details as $detail)
                      <tr>
                        <td><img src="https://ui-avatars.com/api/?name={{ $detail->username }}" 
                          height="60px" class="rounded-circle"></td>
              ...
              <div class="member mt-3">
                ...
                <form class="form-inline" method="post" action="{{ route('checkout-create', $item->id) }}">
                  ...
                  <input type="text" name="username" placeholder="Username" class="form-control mb-2 mr-sm-2" id="username" />

                  <label for="nationality" class="sr-only">Nationality</label>
                  <input type="text" name="nationality" placeholder="nationality"  required style="width: 100px" class="form-control mb-2 mr-sm-2" id="nationality" />

                  <label for="is_visa" class="sr-only">Visa</label>
                  <select name="is_visa" id="is_visa" class="custom-select mb-2 mr-sm-2" required>
                    <option value="" selected val>VISA</option>
                ...
                <p class="disclaimer mb-0">
                  You are only able to invite member that has registered to TravePal
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <p class="payment-instructions">Please complete your payment before start your wonderful trip</p>
              <div class="bank">
