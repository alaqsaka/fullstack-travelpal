        ...
        <div class="row">
          <div class="col-lg-8 pl-lg-0">
            <div class="card card-details">
              <h1>Who is Going?</h1>
              <p>Trip to Nusa Penida, Indonesia</p>
              <div class="attendee">
                <table class="table table-responsive-sm text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">Reyna Shesh</td>
              ...
              <div class="member mt-3">
                ...
                <form action="" class="form-inline">
                  ...
                  <input type="text" name="inputUsername" placeholder="Username" class="form-control mb-2 mr-sm-2" id="inputUsername" />
